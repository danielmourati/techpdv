              ...
              <DialogHeader>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <DialogDescription className="text-xs">
                      Realize a contagem física das cédulas e moedas na gaveta para encerrar o
                      caixa.
                    </DialogDescription>
                  </div>
                </div>
                    ...
                    <div className="flex items-center gap-3 rounded-xl border border-emerald-500/40 bg-emerald-500/10 p-3.5 text-emerald-600">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-emerald-600/90">
                          O valor contado na gaveta confere exatamente com o saldo esperado
                          (Diferença: R$ 0,00).
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="mt-1 text-xs opacity-90">
                            O valor contado ({brl(parsedCountedCash)}) não confere com o esperado (
                            {brl(expectedCash)}). O fechamento regular está bloqueado.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3 rounded-xl border border-rose-500/30 bg-rose-500/5 p-4">
                        ...
                        <p className="text-xs leading-relaxed text-muted-foreground">
                          Para encerrar o turno com divergência de valores, é obrigatório registrar
                          a justificativa do operador e a validação da senha do Administrador.
                        </p>
